...
import 'package:hookup4u_admin/Subscription.dart/package.dart';
import 'package:hookup4u_admin/Subscription.dart/settings.dart';
import 'package:hookup4u_admin/model/customAlert.dart';
import 'package:hookup4u_admin/model/user.dart';
import 'package:hookup4u_admin/screens/Reported_user/reported_user_list.dart';
import 'package:hookup4u_admin/screens/change_password.dart';
import 'package:hookup4u_admin/screens/settings_page.dart';
    ...
    if (lastVisible != null) {
      await collectionReference
        ...
        if (value.documents.length < 1) {
          snackbar('No more data available', _scaffoldKey);
          print("no more data");
          return;
        }
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ReportedUserList()));
                    },
                  ),
                  Divider(
                    thickness: .5,
